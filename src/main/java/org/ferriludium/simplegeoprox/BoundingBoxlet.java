...
/**
 * Holds the coordinates representing the coordinates of a near-rectangular
 * section of the globe: the west- and east-most longitude; and the north- and south-most latitude.
 *
 * NOTE that it is not merely the corners because the globe isn't rectilinear, so this form allows
 * us to create the box with the most inclusive size so that we don't miss any intended portion of
 * the map.
...
public class BoundingBoxlet {
  ...
  public static class Builder {
    ...
    public Builder setLatitudeNorth(double val) {
      latitudeNorth = val;
      return this;
    }

    public Builder setLatitudeSouth(double val) {
      latitudeSouth = val;
      return this;
    }

    public Builder setLongitudeWest(double val) {
      longitudeWest = val;
      return this;
    }

    public Builder setLongitudeEast(double val) {
      longitudeEast = val;
      return this;
    }

    public Builder setLatitudeNorth(LatLng loc) {
      latitudeNorth = loc.getLatitude();
      return this;
    }

    public Builder setLatitudeSouth(LatLng loc) {
      latitudeSouth = loc.getLatitude();
      return this;
    }

    public Builder setLongitudeWest(LatLng loc) {
      longitudeWest = loc.getLongitude();
      return this;
    }

    public Builder setLongitudeEast(LatLng loc) {
      longitudeEast = loc.getLongitude();
      return this;
    }
